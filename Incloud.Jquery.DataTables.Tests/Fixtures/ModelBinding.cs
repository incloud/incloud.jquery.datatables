...
using Incloud.JQuery.Datatables.Tests.TestingUtilities;

namespace Incloud.JQuery.Datatables.Tests
{
    [TestFixture]
    public class ModelBinding
    {
        ...
        {
            Incloud.JQuery.Datatables.Example.RegisterDatatablesModelBinder.Start();
